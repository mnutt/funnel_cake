...
module ScottBarron                   #:nodoc:
  module Acts                        #:nodoc:
    module FunnelStateMachine        #:nodoc:
      ...
      module SupportingClasses
        ...
        class Event
          ...
          def transitions(from, to, trans_opts={})
            @parent.state(from) unless @parent.states.include?(from)
            @parent.state(to) unless @parent.states.include?(to)            
      ...
      module ActMacro
        ...
        def acts_as_funnel_state_machine(opts)
          ...
          self.send(:include, ScottBarron::Acts::FunnelStateMachine::InstanceMethods)
